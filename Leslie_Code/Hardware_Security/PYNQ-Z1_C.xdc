...
##Clock Out--for testing
set_property -dict { PACKAGE_PIN Y9 IOSTANDARD LVCMOS } [get_ports { CLK_OUT }];
...
set_property IOSTANDARD LVCMOS18 [get_ports I_RX]
...
set_property PACKAGE_PIN T5 [get_ports Q_TX]
